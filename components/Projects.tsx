  ...
  return (
    <div className='projects-parent gap-10 h-full w-full bg-neutral-900 flex flex-col sm:items-center p-10 overflow-hidden'>
      ...
      <div className='flex w-full'>
        <div className='projects-container h-full sm:h-[200vh] flex flex-col flex-1 w-full gap-2 sm:gap-10'>
          <div className='project-trigger flex gap-2 border-b-2 border-white'>
            <h2 className='project-text sm:text-2xl font-semibold'>
              PROJECT 1
            </h2>
          </div>
        ...
        <div className='fake-container hidden sm:block h-screen sm:flex-1'></div>
      </div>
    </div>
  )
}
